    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-16 z-40 bg-background/80 backdrop-blur-sm border-0 border-b border-border/30 animate-fade-slide-up">
        <div className="container-adaptive py-8 sm:py-12 md:py-16">
          <div className="flex flex-col lg:flex-row items-center lg:items-center justify-center lg:justify-between gap-6 lg:gap-8">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 lg:gap-4">
              ...
              <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-primary/15 to-accent/10 border-2 border-primary/30 text-primary rounded-2xl text-sm sm:text-base font-black shadow-float backdrop-blur-sm">
                <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
                KairOS Ritual Designer
              </div>
              
              {selectedPendant && (
                <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-primary/10 border border-primary/20 text-primary rounded-xl text-xs sm:text-sm font-medium shadow-minimal">
                  <Shield className="w-3 h-3 sm:w-4 sm:h-4" />
                  {selectedPendant.name}
                </div>
              )}
              {currentRitual && (
                <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-accent/10 border border-accent/20 text-accent rounded-xl text-xs sm:text-sm font-medium shadow-minimal">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                ...
                className={cn(
                  "retro-button p-2.5 sm:p-3 rounded-retro transition-all duration-200 interactive focus-ring shadow-minimal",
                  showRitualPanel 
              ...
              <button
                ...
                className="retro-button p-2.5 sm:p-3 text-muted-foreground hover:text-foreground hover:bg-background/60 rounded-retro transition-all duration-200 interactive focus-ring shadow-minimal"
          ...
          {currentNodes.map((node, index) => {
            ...
            return (
              <div 
                key={node.id} 
                className={cn(
                  "space-y-4 sm:space-y-6 md:space-y-8 animate-fade-slide-up",
                  // Single node gets extra space and prominence
                  currentNodes.length === 1 && "max-w-md w-full scale-105 sm:scale-110"
                )} 
              ...
              >
                ...
                <div className="text-center space-y-1 sm:space-y-2">
                  <h3 className={cn(
                    ...
                    currentNodes.length === 1 ? "text-xl sm:text-2xl" : "text-base sm:text-lg"
                  )}>
                    {node.name}
                  </h3>
                  <p className={cn(
                    "text-muted-foreground",
                    currentNodes.length === 1 ? "text-sm sm:text-base" : "text-xs sm:text-sm"
                  )}>
                    {node.location}
                  </p>
                </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    currentNodes.length === 1 ? "text-sm sm:text-base py-2.5 sm:py-3" : "text-xs sm:text-sm py-2"
                  )}
                  title="View pendant interaction logs for this ESP32"
                >
                  <Hash className={cn(currentNodes.length === 1 ? "w-4 h-4 sm:w-5 sm:h-5" : "w-3 h-3 sm:w-4 sm:h-4")} />
      ...
      <div className="retro-card p-4 sm:p-6 md:p-8 shadow-minimal animate-fade-slide-up">
        <h3 className="text-lg sm:text-xl font-bold text-foreground mb-4 sm:mb-6 text-center">
          <span className="text-primary">//</span> Secure Two-Tap Experience Flow
        </h3>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 text-sm">
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary text-primary-foreground rounded-pixel flex items-center justify-center text-xs sm:text-sm font-bold mx-auto mb-2 sm:mb-3 shadow-pixel">1</div>
            <div className="font-semibold text-primary mb-1 text-xs sm:text-sm">First Tap</div>
            <div className="text-muted-foreground text-xs">Detect pendant</div>
          </div>
          
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent text-accent-foreground rounded-pixel flex items-center justify-center text-xs sm:text-sm font-bold mx-auto mb-2 sm:mb-3 shadow-pixel">2</div>
            <div className="font-semibold text-accent mb-1 text-xs sm:text-sm">Authenticate</div>
            <div className="text-muted-foreground text-xs">Verify identity</div>
          </div>
          
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary text-secondary-foreground rounded-pixel flex items-center justify-center text-xs sm:text-sm font-bold mx-auto mb-2 sm:mb-3 shadow-pixel">3</div>
            <div className="font-semibold text-secondary mb-1 text-xs sm:text-sm">Ready</div>
            <div className="text-muted-foreground text-xs">Awaiting confirm</div>
          </div>
          
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent/80 text-accent-foreground rounded-pixel flex items-center justify-center text-xs sm:text-sm font-bold mx-auto mb-2 sm:mb-3 shadow-pixel">4</div>
            <div className="font-semibold text-accent mb-1 text-xs sm:text-sm">Second Tap</div>
            <div className="text-muted-foreground text-xs">Execute action</div>
          </div>
          
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary text-primary-foreground rounded-pixel flex items-center justify-center text-xs sm:text-sm font-bold mx-auto mb-2 sm:mb-3 shadow-pixel">5</div>
            <div className="font-semibold text-primary mb-1 text-xs sm:text-sm">Processing</div>
            <div className="text-muted-foreground text-xs">Save moment</div>
          </div>
          
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary text-secondary-foreground rounded-pixel flex items-center justify-center text-xs sm:text-sm font-bold mx-auto mb-2 sm:mb-3 shadow-pixel">6</div>
            <div className="font-semibold text-secondary mb-1 text-xs sm:text-sm">Complete</div>
            <div className="text-muted-foreground text-xs">Return to idle</div>
          </div>
        </div>
        
        {/* Technical details */}
        <div className="mt-6 sm:mt-8 p-3 sm:p-4 retro-card">
          <div className="text-xs sm:text-sm text-muted-foreground leading-relaxed space-y-1 sm:space-y-2">
            <div><span className="text-primary font-medium">Purpose:</span> Two-tap design prevents accidental interactions and ensures intentional engagement</div>
            <div><span className="text-accent font-medium">Security:</span> Cryptographic identity verification using decentralized identifiers (DIDs)</div>
            <div><span className="text-primary font-medium">Experience:</span> Familiar tap-to-pay UX pattern adapted for meaningful moment capture</div>
          </div>
        </div>
      </div>
