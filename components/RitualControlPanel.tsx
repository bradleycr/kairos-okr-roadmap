...
export default function RitualControlPanel({ 
  ...
  if (!isOpen) {
    return (
      <button
        onClick={onToggle}
        className="fixed right-8 top-28 z-50 w-14 h-14 bg-gradient-to-br from-indigo-600 to-purple-700 hover:from-indigo-700 hover:to-purple-800 rounded-2xl shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 group"
        title="Open Ritual Designer"
        aria-label="Open Ritual Designer"
      >
        <Wand2 className="w-6 h-6 text-white group-hover:rotate-12 transition-transform duration-300" />
      </button>
    )
  }

  return (
    <div className="fixed right-0 top-0 h-full w-[420px] bg-white shadow-2xl border-l border-gray-200 z-40 overflow-y-auto">
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 p-6 text-white shadow-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm font-medium">Configure MELD Node behaviors</p>
            </div>
          </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex items-center justify-between w-full text-left font-bold text-lg text-gray-900 hover:text-indigo-600 transition-colors"
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <select
                  ...
                  className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-xl text-sm font-medium text-gray-900 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                >
                ...
                <div className="bg-gray-50 rounded-2xl p-5 border border-gray-200">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h3 className="font-bold text-lg text-gray-900 mb-1">{activeRitual.name}</h3>
                      {activeRitual.description && (
                        <p className="text-sm text-gray-600 leading-relaxed">{activeRitual.description}</p>
                      )}
                    </div>
                    <div className="flex gap-2 ml-4">
                      ...
                      <button
                        ...
                        className="p-2 hover:bg-red-50 rounded-lg transition-colors shadow-sm border border-red-200"
                        title="Delete ritual"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {activeRitual.nodes.map(node => {
                      ...
                      return (
                        <div
                          key={node.nodeId}
                          className="inline-flex items-center gap-2 px-3 py-2 bg-white rounded-xl border-2 border-gray-200 text-sm font-medium"
                          style={{ borderLeftColor: getBehaviorColor(node.behavior) }}
                        >
                          {BEHAVIOR_ICONS[node.behavior]}
                          <span className="text-gray-900">{meldNode?.icon} {node.label}</span>
                        </div>
                      )
                    })}
                  </div>
        ...
        <div className="space-y-4 border-t-2 border-gray-100 pt-8">
          <div className="flex items-center justify-between w-full">
            <button
              ...
              className="flex items-center gap-2 text-left font-bold text-lg text-gray-900 hover:text-indigo-600 transition-colors"
            >
            ...
            {showDisplayTextConfig && (
              <button
                ...
                className="p-2 hover:bg-gray-100 rounded-md transition-colors group flex-shrink-0"
                title="Reset to Defaults"
                aria-label="Reset to Defaults"
              >
                <RefreshCw className="w-4 h-4 text-gray-500 group-hover:rotate-180 transition-transform duration-300" />
              </button>
            )}
          </div>
          ...
          {showDisplayTextConfig && (
            <div className="space-y-4">
              <div className="text-sm text-gray-600 mb-4">
                ...
                <span className="block mt-1 text-xs text-indigo-600 font-medium">Changes are saved automatically and applied to live simulations.</span>
              </div>
              
              {/* Waiting State */}
              <div className="border rounded-lg p-3">
                <h4 className="font-medium text-sm mb-2 text-blue-600">Waiting State</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="waiting_title" className="block text-xs font-medium text-gray-700 mb-1">Title</label>
                    <input
                      id="waiting_title"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="waiting_subtitle" className="block text-xs font-medium text-gray-700 mb-1">Subtitle</label>
                    <input
                      id="waiting_subtitle"
                      type="text"
              ...
              {/* NFC Detection State */}
              <div className="border rounded-lg p-3">
                <h4 className="font-medium text-sm mb-2 text-orange-600">NFC Detection</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="detected_title" className="block text-xs font-medium text-gray-700 mb-1">Title</label>
                    <input
                      id="detected_title"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="detected_subtitle" className="block text-xs font-medium text-gray-700 mb-1">Subtitle</label>
                    <input
              ...
              <div className="border rounded-lg p-3">
                <h4 className="font-medium text-sm mb-2 text-green-600">Authentication</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="auth_title" className="block text-xs font-medium text-gray-700 mb-1">Title</label>
                    <input
                      id="auth_title"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="auth_instruction" className="block text-xs font-medium text-gray-700 mb-1">Instruction</label>
                    <input
                      id="auth_instruction"
                      type="text"
              ...
              {/* Confirmation State */}
              <div className="border rounded-lg p-3">
                <h4 className="font-medium text-sm mb-2 text-purple-600">Confirmation</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="confirm_title" className="block text-xs font-medium text-gray-700 mb-1">Title</label>
                    <input
                      id="confirm_title"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="confirm_button" className="block text-xs font-medium text-gray-700 mb-1">Button Text</label>
                    <input
                      id="confirm_button"
                      type="text"
              ...
              {/* Success State */}
              <div className="border rounded-lg p-3">
                <h4 className="font-medium text-sm mb-2 text-emerald-600">Success</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="success_title" className="block text-xs font-medium text-gray-700 mb-1">Title</label>
                    <input
                      id="success_title"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="success_subtitle" className="block text-xs font-medium text-gray-700 mb-1">Subtitle</label>
                    <input
                      id="success_subtitle"
                      type="text"
              ...
              <div className="border rounded-lg p-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="error_title" className="block text-xs font-medium text-gray-700 mb-1">Title</label>
                    <input
                      id="error_title"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="error_subtitle" className="block text-xs font-medium text-gray-700 mb-1">Subtitle</label>
                    <input
                      id="error_subtitle"
                      type="text"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-sm font-medium text-gray-900 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-sm font-medium text-gray-900 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors resize-none"
                    rows={2}
                ...
                {/* Node Configurations */}
                <div className="space-y-4">
                  <h4 className="font-bold text-base text-gray-900">Node Behaviors</h4>
                  {editingRitual.nodes.map(nodeConfig => {
                    const meldNode = MELD_NODES.find(n => n.id === nodeConfig.nodeId)
                    if (!meldNode) return null

                    return (
                      <div key={nodeConfig.nodeId} className="bg-white rounded-2xl p-5 border-2 border-gray-200 space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 border-2 border-gray-200 rounded-lg text-sm font-medium text-gray-900 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                        ...
                        {nodeConfig.behavior === 'custom' && (
                          <div className="space-y-3">
                            ...
                            <textarea
                                ...
                                className="w-full px-3 py-2 border-2 border-gray-200 rounded-lg text-sm font-medium text-gray-900 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors font-mono"
                              rows={4}
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    ...
                    className="flex items-center gap-3 px-6 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 disabled:bg-green-400 transition-all duration-200 text-sm font-bold shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
                    {saveStatus === 'saving' ? (
                  ...
                  <button
                    ...
                    className="px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 text-sm font-bold"
                  >
                    Cancel
                  </button>
                </div>
        ...
        <div className="space-y-4 border-t-2 border-gray-100 pt-8">
          ...
          {expandedSections.export && (
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-cyan-50 to-teal-50 border border-cyan-200 rounded-lg p-4 mb-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-cyan-800 mb-1">📚 Complete Installation Guide</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <h4 className="font-medium text-indigo-600 mb-3">Hardware Requirements</h4>
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-orange-600 hover:bg-orange-500 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg flex items-center justify-center gap-2 font-medium"
              >
